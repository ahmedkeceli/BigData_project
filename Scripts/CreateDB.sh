...
CREATE TABLE transcript (tran_id varchar(255), gene_id varchar(255), length varchar(255), sequence text(25000), PRIMARY KEY(tran_id), CONSTRAINT seq_tranID FOREIGN KEY(gene_id) REFERENCES summaryGene(Locus));
